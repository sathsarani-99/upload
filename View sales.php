...
<title>View Sales</title>
	...
	<link rel="stylesheet" type="text/css" href="view sales style.css">
</head>
...
<table align="center">
	    ...
	    <p>&nbsp;</p>
<div class="box">
			<a href="Today sales.php"><div class="small_box">
			  <p style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: 20px; color: #000000;">Today Sales			  </p></a>
        </div>
			<a href="weakly sales.php"><div class="small_box2">
			  <p style="font-size: 20px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; color: #000000;">This Month Sales</p></a>
			</div>
			<a href="year sales.php"><div class="small_box3">
			  <p style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: 20px; color: #000000;">This year sales</p></a>
			</div>
		</div>
	    <p>&nbsp;</p>
		<p>&nbsp;</p>
